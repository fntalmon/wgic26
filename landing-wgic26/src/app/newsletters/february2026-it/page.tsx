...
const March2026ItalianNewsletter = () => {
  return (
    <div>
      <PageHeader
        title="WGIC26 Newsletter - Febbraio 2026"
            ...
            <div className="bg-neutral-50 p-6 rounded-lg border border-neutral-200">
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex justify-between items-start">
                  ...
                  <span className="font-semibold text-neutral-800">30 aprile 2026</span>
                </li>
                <li className="flex justify-between items-start">
                  <span className="text-neutral-500">
                ...
                <li className="flex justify-between items-start">
                  <span className="text-neutral-500">Partner ed espositori</span>
                  <span className="font-semibold text-neutral-800">30 aprile 2026</span>
                </li>
                <li className="flex justify-between items-start">
                  <span className="text-neutral-500">Sponsor</span>
                  <span className="font-semibold text-neutral-800">30 settembre 2026</span>
                </li>
                <li className="flex justify-between items-start pt-2 border-t border-neutral-200 mt-2">
                  <span className="text-cactus font-bold">Date del congresso</span>
                  <span className="font-bold text-cactus">27-30 ottobre 2026</span>
                </li>
              </ul>
            </div>
          </div>
