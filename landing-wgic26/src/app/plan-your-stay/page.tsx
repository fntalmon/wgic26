    ...
    <div>
      ...
      <section className="container mx-auto py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-white mb-6">Plan Your Stay in Barcelona</h2>
            <p className="text-white/70 mb-8 text-lg leading-relaxed">
              Discover the magic of Barcelona and what makes it the perfect destination for your visit. Watch our guide below.
            </p>
          </div>
          <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl border border-cactus/30 hover:border-cactus/60 transition-colors duration-300 group">
            ...
            <iframe 
              ...
              title="Plan your stay Barcelona"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col gap-6 group">
            ...
            <div className="bg-cactus/10 p-8 rounded-xl border border-white/10 transition-colors group-hover:bg-cactus/20">
              ...
              <p className="text-white/70 mb-6 leading-relaxed">
                Explore the architectural wonders and cultural vibrant life of
                Barcelona.
              </p>
              <a
          ...
          <div className="flex flex-col gap-6 group">
            ...
            <div className="bg-cactus/10 p-8 rounded-xl border border-white/10 transition-colors group-hover:bg-cactus/20">
              ...
              <p className="text-white/70 mb-6 leading-relaxed">
                Discover the Grand Tour de Catalunya and the best gastronomy in
                the world.
              </p>
